...
<head>
    ...
    <title>${grailsApplication.config.tf.org.toolheader} | TIP Defaults</title>
...
<div id="page-body" role="main">
    <div>
        <h1>Change System TIP Defaults</h1>
    </div>

    <div style="margin-top: 3em;">
        <h5><p>On this page, you can set default values for various fields that appear in your published trust interoperability profiles. Please
        note the following important caveats about setting and using these default values.<ul>
        <li>Any changes you make to the default values on this page will be reflected in subsequently imported trust interoperability profiles,
        but changes on this page will NOT affect trust interoperability profiles imported prior to the change.</li>
        <li>The values shown on this page are system-wide defaults. You can override these default values for one or more specific trust
        interoperability profiles by specifying the desired values within an imported XLSX source file, or by using a properties file within
        an imported ZIP source archive.</li></ul></p></h5>
    </div>
